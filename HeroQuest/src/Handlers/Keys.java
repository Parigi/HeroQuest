...
/**
 * array degli attuali e precedenti key states
 * 10 tasti, non tutti utilizzati
 * 
 */
...
public class Keys {
	...
	public static void keySet(int i, boolean b) {
		...
		else if(i == KeyEvent.VK_D) keyState[RIGHT] = b; //VK_RIGHT
		else if(i == KeyEvent.VK_A) keyState[LEFT] = b; //VK_LEFT
